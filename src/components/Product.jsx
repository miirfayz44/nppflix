...
const products = [
  { name: "Фильтр полосовой ФКП2-308-01-1,685-70", img: "/p1.png" },
  { name: "Фильтр перестариваемый полосовой МППФ5-0.9/1.9-4-Б", img: "/p2.png" },
  { name: "Фильтр полосовой ФПР-5-6,5-500-НП", img: "/p3.png" },
  { name: "Фильтр полосовой ФПК-6-2,5-1000-НП", img: "/p4.png" },
  { name: "Фильтр полосовой ФПС-7-1,25-450-НП", img: "/p5.png" },
  { name: "Фильтр полосовой ФПС-9-0,21-120-ГП", img: "/p6.png" },
  { name: "Коммутатор фильтров КПФ-5-1-ГП", img: "/p7.png" },
  { name: "Фильтры нижней частоты ФН-1,83-НМ", img: "/p8.png" },
];
